...
- e400529 fix: 修复切换账号后登录态丢失问题 (v1.0.98)


## [1.0.98] - 2026-07-25

- 3f76c93 v1.0.97: 修复人脸认证闪退 + 崩溃恢复机制
...
- f55accc fix: 微信进程早期返回，跳过 TRAE 多账号逻辑
...
- bbd0d9e fix: 修正版本号为 1.0.74，接续 v1.0.73


## [1.0.7] - 2026-07-19

- fc405ca fix: workflow 增加 tag 重复检测，避免构建失败
- 8f98d75 fix: 添加 hooked_NSLogv 前向声明修复编译错误
- f3e72ba feat: 日志导出改为 zip 打包，全部日志一次性打包导出
- 7c0d654 fix: 修复 DKFilterURLProtocol 认证挑战导致 SIGABRT 闪退
- a061f9f feat: 日志查看器新增导出功能，点击导出按钮可通过系统分享面板导出全部日志
- 99a7105 feat: 新增手机端日志查看器，无需电脑即可查看插件日志


## [1.0.73] - 2026-07-18

- 7a28d31 fix: 增强敏感词过滤深度扫描 + 修复文件分享闪回问题


## [1.0.72] - 2026-07-18

- b8acd13 修复编译错误：isEnabled → enabled + 移除未使用变量
- ccde0be 修复：敏感词过滤改用 NSURLProtocol 底层拦截


## [1.0.71] - 2026-07-18

- c74793a 修复：导出文件崩溃（闪退/白屏消失）


## [1.0.70] - 2026-07-18

- 92d5daf 修复：多开账号文件分享崩溃 + 上传失败
